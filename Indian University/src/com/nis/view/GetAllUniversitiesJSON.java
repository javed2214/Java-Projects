...
/**
 * Servlet implementation class GetAllUniversitiesJSON
 */
@WebServlet("/GetAllUniversitiesJSON")
public class GetAllUniversitiesJSON extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetAllUniversitiesJSON() {
        super();
